...
REF_POS_SCALE = 1.3 # 1.2 is very good!
...
SIM_TOE_OFFSET_LOCAL = [
    np.array([0, -0.02, 0.0]), # default y: -0.05
    np.array([0, -0.02, 0.0]),
    np.array([0, 0.02, 0.0]), # default y: 0.05
    np.array([0, 0.02, 0.0])
]
...
DEFAULT_JOINT_POSE = np.array([-0.13859, 0.480936, -0.761428,    # FR
                               0.13859, 0.480936, -0.761428,    # FL
